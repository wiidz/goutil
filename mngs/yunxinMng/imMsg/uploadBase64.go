...
type UploadBase64Params struct {
	Content   string `json:"content"`   // 字符流base64串(Base64.encode(bytes)) ，最大15M的字符流
...
func (api *Api) UploadBase64(param *UploadBase64Params) (*UploadBase64Resp, error) {
	res, err := api.Client.Post(SubDomain+"upload.action", param, &UploadBase64Resp{})
	return res.(*UploadBase64Resp), err
}
