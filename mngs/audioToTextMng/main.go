...
// Generate 语音转文字
func (mng *AudioToTextMng) Generate(voiceUrl, format, rate string) (data *Resp, err error) {

	res, _, _, err := networkHelper.SendRequest(networkStruct.Post, networkStruct.XWWWForm, URL, map[string]interface{}{
