...
// NewExpressApi  快递接口
func NewExpressApi(config *configStruct.AliApiConfig) *ExpressApi {
	return &ExpressApi{
		Config: config,
	}
}
...
func (api *ExpressApi) GetDetailInfo(expressNo, expressType string) (*DetailRes, error) {
